...
jt.M6502 = function() {
    ...
    var opticks = [
        ...
        7, 6, 2, 8, 2, 3, 5, 5, 3, 3, 2, 3, 2, 4, 6, 6, 2, 5, 2, 8, 2, 4,
        6, 6, 2, 4, 2, 7, 2, 4, 7, 7, 6, 6, 2, 8, 3, 3, 5, 5, 4, 3, 2, 3,
        4, 4, 6, 6, 2, 5, 2, 8, 2, 4, 6, 6, 2, 4, 2, 7, 2, 4, 7, 7, 6, 6,
        2, 8, 2, 3, 5, 5, 3, 3, 2, 2, 3, 4, 6, 6, 2, 5, 2, 8, 2, 4, 6, 6,
        2, 4, 2, 7, 2, 4, 7, 7, 6, 6, 2, 8, 2, 3, 5, 5, 4, 3, 2, 2, 5, 4,
        6, 6, 2, 5, 2, 8, 2, 4, 6, 6, 2, 4, 2, 7, 2, 4, 7, 7, 2, 6, 2, 6,
        2, 2, 2, 3, 2, 2, 2, 2, 4, 4, 4, 4, 2, 6, 2, 6, 4, 4, 4, 4, 2, 5,
        2, 5, 5, 5, 5, 5, 3, 6, 3, 6, 3, 3, 3, 3, 2, 3, 2, 2, 4, 4, 4, 4,
        2, 5, 2, 5, 4, 4, 4, 4, 2, 4, 2, 4, 4, 4, 4, 5, 3, 6, 2, 8, 3, 3,
        5, 5, 2, 3, 2, 2, 4, 4, 6, 6, 2, 5, 2, 8, 2, 4, 6, 6, 2, 4, 2, 7,
        2, 4, 7, 7, 3, 6, 2, 8, 3, 3, 5, 5, 2, 3, 2, 3, 4, 4, 6, 6, 2, 5,
        2, 8, 2, 4, 6, 6, 2, 4, 2, 7, 2, 4, 7, 7 ];

    Javatari.getOpcodeMetadata = function(opcode, address) {
      // TODO: more intelligent maximum cycles
      var i = instructions[opcode];
      return {
        opcode:opcode,
        mnenomic:opcodes[opcode],
        minCycles:opticks[opcode],
        maxCycles:i.length-1,
      };
    }
